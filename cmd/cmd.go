...
func generalUsage() {
  ...
  commands:
    ...
    collect  collect is more intensive and specific than crawl. The result is a mpa of urls with arrays of matched items, such as urls for images, search terms, etc. This does not return full html.
